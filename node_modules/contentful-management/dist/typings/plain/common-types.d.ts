...
export declare type PlainClientAPI = {
    ...
    asset: {
        ...
        get(params: OptionalDefaults<GetSpaceEnvironmentParams & {
            assetId: string;
        } & QueryParams>): Promise<AssetProps>;
    ...
    tag: {
        ...
        update(params: OptionalDefaults<GetTagParams>, rawData: TagProps, headers?: Record<string, unknown>): Promise<TagProps>;
