...
import { DefaultElements, Collection, KeyValueMap, EntityMetaSysProps, MetadataProps, MakeRequest } from '../common-types';
...
export declare const wrapEntryCollection: (makeRequest: {
    ...
    (opts: {
        ...
        payload: {
            name: string;
            fields: import("./content-type-fields").ContentFields[];
    ...
    (opts: {
        ...
        params: import("../common-types").GetSpaceEnvironmentParams & import("../common-types").QueryParams;
    }): Promise<import("../common-types").CollectionProp<EntryProps<any>>>;
    (opts: {
        entityType: "Entry";
        action: "get";
    } & {
    ...
    }): Promise<import("../common-types").CollectionProp<SnapshotProps<EntryProps<any>>>>;
    (opts: {
        entityType: "Snapshot";
        action: "getForEntry";
    } & {
    ...
    }): Promise<SnapshotProps<EntryProps<any>>>;
    (opts: {
        entityType: "Snapshot";
    ...
    (opts: {
        ...
        payload: Pick<import("./tag").TagProps, "name">;
    }): Promise<import("./tag").TagProps>;
    (opts: {
        entityType: "Tag";
        action: "update";
...
}, data: import("../common-types").CollectionProp<EntryProps<Record<string, any>>>) => Collection<Entry, EntryProps<Record<string, any>>>;
export {};
