...
const createWithId = (http, _ref, rawData) => {
...
function createClient(params, opts = {}) {
  ...
  `${sdkMain}/${"7.14.0"}`, params.application, params.integration, params.feature);
...
function createEntryApi(makeRequest) {
  ...
  return {
    ...
    getSnapshots: function getSnapshots(query = {}) {
      ...
      }).then(data => Object(_snapshot__WEBPACK_IMPORTED_MODULE_4__["wrapSnapshotCollection"])(makeRequest, data));
    },
    getSnapshot: function getSnapshot(snapshotId) {
      const _getParams8 = getParams(this),
            params = _getParams8.params;
      ...
      }).then(data => Object(_snapshot__WEBPACK_IMPORTED_MODULE_4__["wrapSnapshot"])(makeRequest, data));
    },
    isPublished: function isPublished() {
      const raw = this.toPlainObject();
...
function wrapEntry(makeRequest, data) {
  const entry = Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_1__["toPlainObject"])(Object(fast_copy__WEBPACK_IMPORTED_MODULE_0__["default"])(data));
  const entryWithMethods = Object(_enhance_with_methods__WEBPACK_IMPORTED_MODULE_2__["default"])(entry, createEntryApi(makeRequest));
