        ...
        <div className="container">
          ...
          <div className="details-about">
            ...
            <p>
              ...
              sanctus est Lorem ips um dolor sit amet. Lorem ipsum dolor sit
              amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor
              invidunt ut labore et dolore mag na aliquyam erat, sed diam
          ...
          <div className="details-problem">
            ...
            <div className="row">
              <div className="col-sm-6 col-lg-6">
                <div className="img">
                  <img
                    src="/images/case-study/case-study-details2.jpg"
                    alt="Details"
                  />
                </div>
              </div>
              <div className="col-sm-6 col-lg-6">
                <div className="img">
                  <img
                    src="/images/case-study/case-study-details3.jpg"
                    alt="Details"
                  />
                </div>
              </div>
          ...
          <div className="contact-area pb-70">
            <div className="container">
              <div className="section-title">
                <h2>
                  Have Any Project? Just <span>Drop A Line</span>. I Always Love
                  To Hear From You
                </h2>
              </div>
