    ...
    <div id="portfolio" className="case-study-area two pb-100">
      <div className="container">
        <div className="section-title five">
          <h2>
            Some In Depth <span>Case Study</span> Of My Successful Project
          </h2>
        </div>
        ...
        <div className="row align-items-center">
          <div className="col-sm-6 col-lg-7">
            <div className="case-study-img">
              <div className="overlay">
                ...
                <div className="inner">
                  <h3>
                    <Link to="/case-study-details">Furniture Website</Link>
                  </h3>
                  <span>Logo</span>
                </div>
              </div>
          ...
          <div className="col-sm-6 col-lg-5">
            <div className="case-study-content">
              <h3>
                <Link to="/case-study-details">ERP Software Logo</Link>
              </h3>
              <p>
                Lorem ipsum dolor sit amet, consetetur sadip scing elitr, sed
                diam nonumy eirmod tempor invidunt ut labore et dolore magna
          ...
          <div className="col-sm-6 col-lg-7">
            <div className="case-study-img">
              <div className="overlay">
                ...
                <div className="inner">
                  <h3>
                    <Link to="/case-study-details">ERP Website</Link>
                  </h3>
                  <span>ERP</span>
                </div>
              </div>
          ...
          <div className="col-sm-6 col-lg-5">
            <div className="case-study-content">
              <h3>
                <Link to="/case-study-details">Travel App Logo Design</Link>
              </h3>
              <p>
                Lorem ipsum dolor sit amet, consetetur sadip scing elitr, sed
                diam nonumy eirmod tempor invidunt ut labore et dolore magna
