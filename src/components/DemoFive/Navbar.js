...
import logo from '../../components/App/assets/images/logo-six.png'
...
const Navbar = () => {
    ...
    return (
        <React.Fragment>
            <nav id="navbar" className="navbar navbar-expand-md navbar-light five fixed-top">
