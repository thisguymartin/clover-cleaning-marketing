...
import about from '../../components/App/assets/images/about2.jpg'

const AboutMe = () => {
    return (
        <div id="about" className="about-area five pb-70">
                    ...
                    <div className="col-lg-6">
                        <div className="about-content">
                            <div className="section-title five">
                                <h2>Short Story <span>About Me</span>. How I Give Colors To The Digital World Like This</h2>
