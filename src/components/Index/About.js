      ...
      <div className="container">
        <div className="about-content">
          <div className="section-title">
            ...
            <h2>
              I Am A Project Manager, Specialized In Gatsby/React Based Design &
              Development
            </h2>
            <p>
              Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam
              nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam
              erat, seddiam voluptua. At vero eos et accusam et justo duo
              dolores et ea rebum.
            </p>
          </div>
            ...
            <div className="col-sm-6 col-lg-6">
              <div className="left">
                <ul>
                  ...
                  <li>
                    <span>Address:</span>
                    <Link to="#">12/7, Mc Street, Canada</Link>
                  </li>
                </ul>
              </div>
            </div>
