            ...
            <div className="portfolio-item">
              ...
              <div className="bottom">
                <div className="bottom-one">
                  <h3>
                    <Link to="/case-study-details">Restaurant App</Link>
                  </h3>
          ...
          <div className="col-sm-6 col-lg-6">
            <div className="portfolio-item">
              ...
              <div className="bottom">
                <div className="bottom-one">
                  <h3>
                    <Link to="/case-study-details">Vegetable Shop</Link>
                  </h3>
                  <span>Vegetable</span>
                </div>
                <div className="bottom-two">
          ...
          <div className="col-lg-12">
            <div className="portfolio-item">
              ...
              <div className="bottom">
                <div className="bottom-one">
                  <h3>
                    <Link to="/case-study-details">Business Card Design</Link>
                  </h3>
                  <span>Card</span>
                </div>
                <div className="bottom-two">
                  <p>
                    ...
                    Doloribus nostrum ipsam suscipit dignissimos quis animi quod
                    culpa
                  </p>
                  <Link to="/case-study-details">
                    Explore More <i className="flaticon-right-arrow"></i>
          ...
          <div className="col-sm-6 col-lg-6">
            <div className="portfolio-item">
              ...
              <div className="bottom">
                <div className="bottom-one">
                  <h3>
                    <Link to="/case-study-details">Food Illustration</Link>
                  </h3>
          ...
          <div className="col-sm-6 col-lg-6">
            <div className="portfolio-item">
              ...
              <div className="bottom">
                <div className="bottom-one">
                  <h3>
                    <Link to="/case-study-details">Package Design</Link>
                  </h3>
                  <span>Package</span>
                </div>
                <div className="bottom-two">
