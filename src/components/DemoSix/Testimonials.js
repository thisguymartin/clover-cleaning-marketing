...
const Testimonials = () => {
  ...
  return (
    <div className="review-area two six pb-100">
      <div className="container">
        <div className="section-title six">
          <h2>
            See What People <span>Say</span> About My Design's Work & Express
          </h2>
        </div>
          ...
          >
            <div className="review-item">
              ...
              <p>
                ...
                Doloribus enim illo magni debitis in at culpa quidem eum
                molestiae reiciendis provident, officiis consequatur voluptates
                error maiores, pariatur natus ex quaerat
              </p>
