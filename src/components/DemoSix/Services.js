    ...
    <div className="what-area six pb-70">
      <div className="container">
        <div className="section-title six">
          ...
          <h2>
            The <span>Services</span> That I Provide For My Client's Ultimate
            Satisfaction
          </h2>
        </div>
        ...
        <div className="row">
          <div className="col-sm-6 col-lg-4">
            <div className="what-item">
              ...
              <h3>
                <Link to="/service-details">Wedding Photography</Link>
              </h3>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Inventore animi praesentium tenetur earum accusantium
              </p>
          ...
          <div className="col-sm-6 col-lg-4">
            <div className="what-item">
              ...
              <h3>
                <Link to="/service-details">Personal Photography</Link>
              </h3>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Inventore animi praesentium tenetur earum accusantium
          ...
          <div className="col-sm-6 col-lg-4">
            <div className="what-item">
              ...
              <h3>
                <Link to="/service-details">Pre-wedding Photography</Link>
              </h3>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Inventore animi praesentium tenetur earum accusantium
          ...
          <div className="col-sm-6 col-lg-4">
            <div className="what-item">
              ...
              <h3>
                <Link to="/service-details">Commercial Photography</Link>
              </h3>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Inventore animi praesentium tenetur earum accusantium
          ...
          <div className="col-sm-6 col-lg-4">
            <div className="what-item">
              ...
              <h3>
                <Link to="/service-details">Travel Photography</Link>
              </h3>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Inventore animi praesentium tenetur earum accusantium
          ...
          <div className="col-sm-6 col-lg-4">
            <div className="what-item">
              ...
              <h3>
                <Link to="/service-details">Nature Photography</Link>
              </h3>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Inventore animi praesentium tenetur earum accusantium
