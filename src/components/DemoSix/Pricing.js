    ...
    <div className="pricing-area pb-70">
      <div className="container">
        <div className="section-title six">
          <h2>
            Here Are My Affordable <span>Pricing</span> To Choose Your Best One
          </h2>
        </div>
            ...
            <div className="pricing-item mt5">
              ...
              <div className="end">
                <ul>
                  ...
                  <li>
                    <del>Provide Soft Copy</del>
                  </li>
                  <li>
                    <del>2 Junior Photographer</del>
                  </li>
                  <li>
                    <del>Provide Hard Copy</del>
                  </li>
                </ul>
