      ...
      <div className="container">
        <div className="section-title three">
          ...
          <p>
            ...
            erat, seddiam voluptua. At vero eos et accusam et.
          </p>
        </div>
        ...
        <div className="row">
          <div className="col-sm-6 col-lg-6">
            <div className="what-item">
              ...
              <h3>
                <Link to="/service-details">Web Design</Link>
              </h3>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Voluptatum assumenda at doloribus dolore quae quibusdam
              </p>
          ...
          <div className="col-sm-6 col-lg-6">
            <div className="what-item">
              ...
              <h3>
                <Link to="/service-details">App Design</Link>
              </h3>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Voluptatum assumenda at doloribus dolore quae quibusdam
          ...
          <div className="col-sm-6 col-lg-6">
            <div className="what-item">
              ...
              <h3>
                <Link to="/service-details">Illustration</Link>
              </h3>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Voluptatum assumenda at doloribus dolore quae quibusdam
