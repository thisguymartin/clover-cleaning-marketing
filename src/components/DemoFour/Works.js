    ...
    <div id="portfolio" className="work-area ptb-100">
      <div className="container">
        <div className="section-title four">
          <h2>
            At First See My Awesome <span>Work</span> That Gain A Vast
            Popularity
          </h2>
        </div>
          ...
          <div className="col-lg-4">
            <div className="work-item">
              <div className="overlay">
                ...
                <div className="inner">
                  <h3>
                    <Link to="/work-details">Pancake Logo</Link>
                  </h3>
                </div>
              </div>
            </div>
            ...
            <div className="work-item">
              <div className="overlay">
                ...
                <div className="inner">
                  <h3>
                    <Link to="/work-details">Business Card</Link>
                  </h3>
                </div>
              </div>
            </div>
            ...
            <div className="work-item">
              <div className="overlay">
                ...
                <div className="inner">
                  <h3>
                    <Link to="/work-details">Brochure</Link>
                  </h3>
                </div>
              </div>
            </div>
          ...
          <div className="col-lg-5">
            ...
            <div className="work-item">
              <div className="overlay">
                ...
                <div className="inner">
                  <h3>
                    <Link to="/work-details">Packaging</Link>
                  </h3>
                </div>
              </div>
            </div>
            ...
            <div className="work-item">
              <div className="overlay">
                ...
                <div className="inner">
                  <h3>
                    <Link to="/work-details">Illustration</Link>
                  </h3>
                </div>
              </div>
            </div>
          ...
          <div className="col-lg-3">
            <div className="work-item">
              <div className="overlay">
                ...
                <div className="inner">
                  <h3>
                    <Link to="/work-details">UX/UI</Link>
                  </h3>
                </div>
              </div>
            </div>
            ...
            <div className="work-item">
              <div className="overlay">
                ...
                <div className="inner">
                  <h3>
                    <Link to="/work-details">Web Design</Link>
                  </h3>
                </div>
              </div>
            </div>
            ...
            <div className="work-item">
              <div className="overlay">
                ...
                <div className="inner">
                  <h3>
                    <Link to="/work-details">Web Development</Link>
                  </h3>
                </div>
              </div>
            </div>
            ...
            <div className="work-item">
              <div className="overlay">
                ...
                <div className="inner">
                  <h3>
                    <Link to="/work-details">Animation</Link>
                  </h3>
                </div>
              </div>
            </div>
